...
export default function TypeAheadActores(props: typeAheadActoresProps) {
    ...
    const actores: actorPeliculaDTO[] = [
        {
            id: 1, nombre: 'Cristian', personaje: '', foto: 'https://m.media-amazon.com/images/M/MV5BNzZiNTEyNTItYjNhMS00YjI2LWIwMWQtZmYwYTRlNjMyZTJjXkEyXkFqcGdeQXVyMTExNzQzMDE0._V1_UX214_CR0,0,214,317_AL_.jpg'
        },
        {
        ...
        {
            id: 3, nombre: 'Felipe', personaje: '', foto: 'https://m.media-amazon.com/images/M/MV5BMjI0MTg3MzI0M15BMl5BanBnXkFtZTcwMzQyODU2Mw@@._V1_UY317_CR10,0,214,317_AL_.jpg'
        }
    ]
